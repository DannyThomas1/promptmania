  ...
  return (
    <div className="prompt_card">
      <div className="flex justify-between items-start gap-5">
        <div className="flex-1 flex justify-start items-center gap-3 cursor-pointer" onClick={profileClick}>
          {post.creator.image ? (
            <Image
      ...
      {session?.user?.id === post.creator._id && pathName === '/profile' && (
        <div className="mt-5 flex-center gap-4 border-t border-gray-100 pt-3">
          ...
          <p className="font-inter text-sm text-orange-400 cursor-pointer" onClick={handleDelete}>
            Delete
          </p>
        </div>
      )}
